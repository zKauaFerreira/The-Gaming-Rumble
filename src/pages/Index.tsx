...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className={`animate-fade-in-up bg-card border border-border rounded-2xl p-6 md:p-10 max-w-lg w-full shadow-2xl ${state === "loading" ? "animate-pulse-glow" : ""}`}>
          ...
          <div className="mb-6">
            <div className="relative rounded-xl overflow-hidden mb-4">
              ...
              <div className="absolute bottom-3 left-4 right-4">
                <h1 className="text-xl md:text-2xl font-bold text-white drop-shadow-lg">{gameData.title}</h1>
              </div>
            </div>
        ...
        {state === "fallback" && (
          <div className="animate-fade-in-up space-y-4">
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-4">Se nada acontecer, use os botões abaixo</p>
            </div>
            <button
